    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-instance">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Fat-Client Collector</h1>
          ...
          <div class="row-instance">
			...
			<!-- Content Row 1-->
            <div class="col-xl-collector col-lg-4">

              <!-- Area Chart -->
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Fat-Client Instance 1 Collector</h6>
                </div>
                <div class="card-body">
                  <div class="chart-area-result3">
                  	<div>Input Image Size : 658 x 468 px</div></br>
                    <img src="${pageContext.request.contextPath}/resources/image/in1.jpg" style="width:inherit; height:auto; max-width:100%;">
                  </div>
                  <hr>
                  <div class="chart-area-result3">
                    <div>Output Image Size : 650 x 460 px</div></br>
                    <img src="${pageContext.request.contextPath}/resources/image/in11.jpg" style="width:inherit; height:auto; max-width:100%;">
                  </div>
                </div>
              </div>
             </div>
            ...
            <div class="col-xl-collector col-lg-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Fat-Client Instance 2 Collector</h6>
                </div>
                <div class="card-body">
                  <div class="chart-area-result3">
                  	<div>Input Image Size : 900 x 702 px</div></br>
                    <img src="${pageContext.request.contextPath}/resources/image/in4.jpg" style="width:inherit; height:auto; max-width:100%;">
                  </div>
                  <hr>
                  <div class="chart-area-result3">
                    <div>Output Image Size : 650 x 460 px</div></br>
                    <img src="${pageContext.request.contextPath}/resources/image/in44.jpg" style="width:inherit; height:auto; max-width:100%;">
                  </div>
                </div>
              </div>
             </div>
            ...
            <div class="col-xl-collector col-lg-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Fat-Client Instance 3 Collector</h6>
                </div>
                <div class="card-body">
                  <div class="chart-area-result3">
                  	<div>Input Image Size : 900 x 673 px</div></br>
                    <img src="${pageContext.request.contextPath}/resources/image/in6.jpg" style="width:inherit; height:auto; max-width:100%;">
                  </div>
                  <hr>
                  <div class="chart-area-result3">
                    <div>Output Image Size : 650 x 460 px</div></br>
                    <img src="${pageContext.request.contextPath}/resources/image/in66.jpg" style="width:inherit; height:auto; max-width:100%;">
                  </div>
                </div>
              </div>
             </div>
