    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-instance">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Analysis Result</h1>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="chart-area-result">
                    ...
                    <img src="${pageContext.request.contextPath}/resources/image/out1.jpg" style="width:inherit; height:auto; max-width:100%;">
                  </div>
                  <br/><hr>
                  <div class="chart-area-result2">
                    Number Palte Number : ${numText} <br/>
                    Context Information : This car, isNow, Permission
                  </div>
                </div>
              </div>
